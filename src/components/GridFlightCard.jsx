...
export const GridFlightCard = ({ flight, searchParams={} }) => {
  ...
  return (
    <div
      ...
      } rounded-lg shadow-md p-6 hover:shadow-xl transition-shadow duration-300`}
    >
      ...
      <div className="flex justify-between items-center my-6">
        <div>
          ...
          <p className={`${darkMode ? "text-gray-300" : "text-gray-600"}`}>
           {searchParams.departure || 'Departure Not Specified'}
          </p>
        </div>
        <div className="flex flex-col items-center">
          <div className="w-32 border-t-2 border-gray-300 relative">
            <FaPlane
              className={`${
